...
class EntradaEstoqueForm(MovimentoForm):
    ...
    class Meta(MovimentoForm.Meta):
        ...
        labels['data_movimento'] = _('输入日期')
        labels['tipo_movimento'] = _('类型')
        labels['pedido_compra'] = _('采购订单')
        labels['fornecedor'] = _('供应商')
        labels['local_dest'] = _('目的地')
...
class SaidaEstoqueForm(MovimentoForm):
    ...
    class Meta(MovimentoForm.Meta):
        ...
        labels = MovimentoForm.Meta.labels
        labels['data_movimento'] = _('输出日期')
        labels['tipo_movimento'] = _('类型')
        labels['pedido_venda'] = _('销售订单')
        labels['local_orig'] = _('原产地')
