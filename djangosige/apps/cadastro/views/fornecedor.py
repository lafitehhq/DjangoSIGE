...
class EditarFornecedorView(EditarPessoaView):
    ...
    success_url = reverse_lazy('cadastro:listafornecedoresview')
    success_message = "供应商 <b>%(nome_razao_social)s </b>编辑成功。"
